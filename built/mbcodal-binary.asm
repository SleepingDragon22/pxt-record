...
; Virtual methods: 0 / 0
; generated code sizes (bytes): 2084 (incl. 1378 user, 662 helpers, 12 vtables, 32 lits); src size 0
; assembly: 1366 lines; density: Infinity bytes/stmt; (0 stmts)
; total bytes: 292900 (55.9% of 512.0k flash with 231388 free)
...
; start
    ...
    .hex 97EED059741843B7 ; hex template hash
